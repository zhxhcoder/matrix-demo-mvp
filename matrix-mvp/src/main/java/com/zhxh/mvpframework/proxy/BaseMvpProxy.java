...
public class BaseMvpProxy<V extends BaseMvpView, P extends BaseMvpPresenter<V>> implements PresenterProxyInterface<V, P>{
    ...
    public P getMvpPresenter() {
        Log.e("matrix-mvp","Proxy getMvpPresenter");
        if (mFactory != null) {
            if (mPresenter == null) {
        ...
        Log.e("matrix-mvp","Proxy getMvpPresenter = " + mPresenter);
        return mPresenter;
    }
    ...
    public void onResume(V mvpView) {
        getMvpPresenter();
        Log.e("matrix-mvp","Proxy onResume");
    ...
    private void onDetachMvpView() {
        Log.e("matrix-mvp","Proxy onDetachMvpView = ");
        if (mPresenter != null && mIsAttchView) {
    ...
    public void onDestroy() {
        Log.e("matrix-mvp","Proxy onDestroy = ");
        if (mPresenter != null ) {
            onDetachMvpView();
    ...
    public Bundle onSaveInstanceState() {
        Log.e("matrix-mvp","Proxy onSaveInstanceState = ");
    ...
    public void onRestoreInstanceState(Bundle savedInstanceState) {
        Log.e("matrix-mvp","Proxy onRestoreInstanceState = ");
        Log.e("matrix-mvp","Proxy onRestoreInstanceState Presenter = " + mPresenter);
